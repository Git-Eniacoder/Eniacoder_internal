...
session_start();
$query = "SELECT * FROM task_list WHERE task_assign_to='".$_SESSION['email']."' AND task_status='close'";
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
		...
		<p class="card-text"><span style="font-weight:bold">Status:</span>'.$result["task_status"].'</p>
      </div>
    </div>
  </div>';
}
